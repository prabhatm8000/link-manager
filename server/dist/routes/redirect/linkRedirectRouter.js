...
linkRedirectRouter.get(`/:shortUrlKey([a-zA-Z0-9]{${configs_1.shortUrlKeyLength}})`, UAMiddleware_1.default, linkRedirectController_1.default.redirectToDestination);
